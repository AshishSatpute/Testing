...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public MyViewHolder(View itemView) {
            ...
            btn_plus.setTag(R.id.plus, itemView);
            btn_minus.setTag(R.id.minus, itemView);
        ...
        public void onClick(View v) {
            ...
            if (v.getId() == btn_plus.getId()){
                ...
                View tempview = (View) btn_plus.getTag(R.id.plus);
                ...
                View tempview = (View) btn_minus.getTag(R.id.minus);
                TextView tv = (TextView) tempview.findViewById(R.id.number);
                int number = Integer.parseInt(tv.getText().toString()) - 1;
                tv.setText(String.valueOf(number));
                MainActivity.modelArrayList.get(getAdapterPosition()).setNumber(number);
